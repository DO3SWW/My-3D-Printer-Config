...
#define STRING_CONFIG_H_AUTHOR "DO3SWW" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 531.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 405.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 221.0              // (mm) Get this value from G33 auto calibrate
...
#define XYZ_BELT_PITCH 1.25
#define XYZ_PULLEY_TEETH 12.23

// delta speeds must be the same on xyz
#define DEFAULT_XYZ_STEPS_PER_UNIT  166.5729
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 197.00 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 35, -0.5 }
